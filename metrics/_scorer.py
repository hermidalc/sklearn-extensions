...
class _PredictScorer(_BaseScorer):
    def _score(
        self, method_caller, estimator, X, y_true, sample_weight=None, **predict_params
    ):
        """Evaluate predicted target values for X relative to y_true.
...
class _ProbaScorer(_BaseScorer):
    def _score(
        self, method_caller, clf, X, y, sample_weight=None, **predict_proba_params
    ):
        ...
        y_pred = method_caller(clf, "predict_proba", X, **predict_proba_params)
...
class _ThresholdScorer(_BaseScorer):
    def _score(self, method_caller, clf, X, y, sample_weight=None, **predict_params):
        ...
        if is_regressor(clf):
            ...
            try:
                y_pred = method_caller(clf, "decision_function", X, **predict_params)
