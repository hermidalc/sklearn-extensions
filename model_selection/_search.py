...
__all__ = ["ExtendedGridSearchCV", "ExtendedRandomizedSearchCV"]
...
class ExtendedBaseSearchCV(BaseSearchCV):
    ...
    def score_samples(self, X, **score_sample_params):
        ...
        """
        check_is_fitted(self)
        return self.best_estimator_.score_samples(X, **score_sample_params)
    ...
    def predict_proba(self, X, **predict_proba_params):
        ...
        """
        check_is_fitted(self)
        return self.best_estimator_.predict_proba(X, **predict_proba_params)
    ...
    def predict_log_proba(self, X, **predict_log_proba_params):
        ...
        """
        check_is_fitted(self)
        return self.best_estimator_.predict_log_proba(X, **predict_log_proba_params)
    ...
    def decision_function(self, X, **decision_function_params):
        ...
        """
        check_is_fitted(self)
        return self.best_estimator_.decision_function(X, **decision_function_params)
    ...
    def inverse_transform(self, Xt, **inverse_transform_params):
        ...
        """
        check_is_fitted(self)
        return self.best_estimator_.inverse_transform(Xt, **inverse_transform_params)
    ...
    def fit(self, X, y=None, **fit_params):
        ...
        **fit_params : dict of str -> object
        ...
        n_splits = cv_orig.get_n_splits(X, y, **cv_params)
            ...
            def evaluate_candidates(candidate_params, cv=None, more_results=None):
                ...
                out = parallel(
                    ...
                    for (cand_idx, parameters), (split_idx, (train, test)) in product(
                        ...
                        enumerate(cv.split(X, y, **cv_params)),
                    )
                )
