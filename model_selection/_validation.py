...
def permutation_test_score(estimator, X, y, scoring=None, cv=None,
    ...
    estimator : {list, tuple, set} of estimator instance or a single \
            estimator instance
        The estimator or group of estimators used to fit the data.
    ...
    score = _permutation_test_score(clone(estimator), X, y, cv, scorer,
                                    cv_params, fit_params, score_params,
                                    feature_params)
...
def _permutation_test_score(estimator, X, y, cv, scorer, cv_params,
    ...
    for cv_idx, (train, test) in enumerate(cv.split(X, y, **cv_params)):
        ...
        estimator_instance = (estimator[cv_idx] if estimator_is_list else
                              estimator)
        ...
        scores.append(scorer(estimator_instance, X_test, y_test,
                             **test_score_params))
...
def learning_curve(estimator, X, y, groups=None,
                   ...
                   fit_params=None, param_routing=None):
    """Learning curve.
    ...
    cv_iter = list(cv.split(X, y, **cv_params))
    ...
    if exploit_incremental_learning:
        ...
        out = parallel(delayed(_incremental_fit_estimator)(
            ...
            scorer, verbose, return_times, fit_params,
            score_params=score_params, feature_params=feature_params)
        ...
        out = parallel(delayed(_fit_and_score)(
            clone(estimator), X, y, scorer, train, test, verbose, None,
            fit_params, score_params=score_params,
            feature_params=feature_params, return_train_score=True,
    ...
    for n_train_samples, partial_train in partitions:
        ...
        if y_partial_train is None:
            ...
            estimator.partial_fit(X_partial_train, y_partial_train,
                                  classes=classes, **partial_fit_params)
...
def validation_curve(estimator, X, y, param_name, param_range, groups=None,
    ...
    out = parallel(delayed(_fit_and_score)(
        ...
        for train, test in cv.split(X, y, **cv_params) for v in param_range)
    out = np.asarray(out)
