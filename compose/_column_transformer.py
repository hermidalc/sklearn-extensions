...
class ExtendedColumnTransformer(ExtendedTransformerMixin, ColumnTransformer):
    ...
    def __init__(
        ...
        *,
        ...
        self.router = check_routing(
            self.param_routing,
            [[name, "*"] for name, trans, _ in self.transformers if trans != "drop"],
    ...
    def _fit_transform(
        self, X, y, func, fitted=False, column_as_strings=False, fit_params=None
    ):
        """
    ...
    def fit_transform(self, X, y=None, **fit_params):
        ...
        result = self._fit_transform(X, y, _fit_transform_one, fit_params=fit_params)
...
def make_extended_column_transformer(
    *transformers,
    remainder="drop",
    sparse_threshold=0.3,
    n_jobs=None,
